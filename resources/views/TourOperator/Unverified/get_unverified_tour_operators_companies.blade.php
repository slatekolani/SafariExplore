<table class="table table-hover table-responsive-md" id="Unverified_tour_operators_companies-table">
    <thead>
    <tr>
        <th>@lang('#')</th>
...
@push('after-scripts')
    ...
    <script  type="text/javascript">
        ...
        $(function() {
            var url = "{{ url("/") }}";
            $('#Unverified_tour_operators_companies-table').DataTable({
                processing: true,
                serverSide: true,
                stateSave: true,
                searching: true,
                ...
                ajax: '{{ route('tourOperator.getUnverifiedTourCompanies') }}',
                columns: [
