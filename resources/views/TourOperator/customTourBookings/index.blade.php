@extends('layouts.main', ['title' => trans('Custom Tour Bookings'), 'header' => trans('Custom Tour Bookings')])
    ...
    <div class="row" style="overflow-x: scroll">
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:300%;background-color:rgba(255,255,255,0.85)">
                ...
                @include('TourOperator.customTourBookings.get_custom_tour_bookings')
            </section>
        </div>
