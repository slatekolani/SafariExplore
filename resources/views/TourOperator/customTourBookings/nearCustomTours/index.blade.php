@extends('layouts.main', ['title' => trans('Near Tours'), 'header' => trans('Near Tours To be Conducted')])
    ...
    <div class="row" style="overflow-x: scroll">
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:300%;background-color:rgba(255,255,255,0.85)">
                ...
                @include('TourOperator.customTourBookings.nearCustomTours.get_near_custom_tours')
            </section>
        </div>
