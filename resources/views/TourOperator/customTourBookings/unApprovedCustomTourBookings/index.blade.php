@extends('layouts.main', ['title' => trans('Un Approved Custom Tour Bookings'), 'header' => trans('Un Approved Custom Tour Bookings')])
            ...
            <div class="list-group">
                <ul class="list-unstyled">
                    <a href="{{route('customTourBookings.nearCustomTourIndex',$tourOperator->uuid)}}" class="list-group-item list-group-item-action">
                        <h5 class="list-group-item-heading"><i class="fas fa-clipboard"></i> {{ __('Near Tours') }} ~ <badge class="badge badge-primary" style="font-size: 14px">{{$tourOperator->TotalNearCustomToursLabel}}</badge></h5>
                        <p class="list-group-item-text"></p>
                    </a>
                </ul>
            </div>
            ...
            <div class="list-group">
                <ul class="list-unstyled">
                    <a href="{{route('customTourBookings.expiredCustomTourBookingsIndex',$tourOperator->uuid)}}" class="list-group-item list-group-item-action">
                        <h5 class="list-group-item-heading"><i class="fas fa-clipboard"></i> {{ __('Expired Bookings') }} ~ <badge class="badge badge-primary" style="font-size: 14px">{{$tourOperator->TotalExpiredCustomTourBookingsLabel}}</badge></h5>
                        <p class="list-group-item-text"></p>
                    </a>
                </ul>
            </div>
            ...
            <div class="list-group">
                <ul class="list-unstyled">
                    <a href="{{route('customTourBookings.DeletedCustomBookingsIndex',$tourOperator->uuid)}}" class="list-group-item list-group-item-action">
                        <h5 class="list-group-item-heading"><i class="fas fa-clipboard"></i> {{ __('Retrieve deleted bookings') }} ~ <badge class="badge badge-primary" style="font-size: 14px">{{$tourOperator->TotalRetrievedDeletedCustomBookingsLabel}}</badge></h5>
                        <p class="list-group-item-text"></p>
                    </a>
                </ul>
            </div>
    ...
    <div class="row" style="overflow-x: scroll">
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:300%;background-color:rgba(255,255,255,0.85)">
                ...
                @include('TourOperator.customTourBookings.unApprovedCustomTourBookings.get_un_approved_custom_tour_bookings')
            </section>
        </div>
