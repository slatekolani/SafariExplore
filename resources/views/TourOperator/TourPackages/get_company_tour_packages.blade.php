<table class="table table-hover table-responsive-md" id="tour_packages-table" style="background-color: rgba(255,255,255,0.6);color: black">
    <thead>
    <tr>
        <th>@lang('#')</th>
...
@push('after-scripts')
    ...
    <script  type="text/javascript">
        ...
        $(function() {
            var url = "{{ url("/") }}";
            var table=$('#tour_packages-table').DataTable({
                processing: true,
                serverSide: true,
                stateSave: true,
                searching: true,
                ...
                ajax: '{{ route('tourPackages.getCompanyTourPackages',$tourOperator->id) }}',
                columns: [
                    { data: 'id', name: 'id', orderable: true, searchable: true},
                    { data: 'tourPackagePostedTime', name: 'tourPackagePostedTime', orderable: true, searchable: false},
                    { data: 'companyPostedTourPackage', name: 'companyPostedTourPackage', orderable: true, searchable: true},
                    ...
                    { data: 'safari_start_date', name: 'safari_start_date', orderable: false, searchable: true},
                    { data: 'safari_end_date', name: 'safari_end_date', orderable: false, searchable: true},
