@extends('layouts.main', ['title' => trans('Recent Tour Packages'), 'header' => trans('Recent Tour Packages')])
    ...
    <div class="row" style="overflow-x: scroll">
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:180%;">
                ...
                @include('TourOperator.TourPackages.recentPostedTourPackages.get_recent_posted_tour_packages')
            </section>
        </div>
    </div>
