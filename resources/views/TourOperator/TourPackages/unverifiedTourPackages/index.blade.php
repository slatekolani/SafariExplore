@extends('layouts.main', ['title' => trans('Un Verified Tour Packages'), 'header' => trans('Un Verified Tour Packages')])
    ...
    <div class="row" style="overflow-x: scroll">
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:180%;">
                ...
                @include('TourOperator.TourPackages.unverifiedTourPackages.get_unverified_tour_packages')
            </section>
        </div>
    </div>
