@extends('layouts.main', ['title' => trans('Tour Packages'), 'header' => trans('Tour Packages')])
...
@section('content')
    ...
    <div class="row">
        @if(Auth::user()->hasRole(2))
            <div class="col-md-12">
                <div class="pull-left">
                    <a class='textWhite' href="{{route('tourPackages.create',$tourOperator->uuid)}}"><i
                            class="fas fa-pencil-alt"></i>&nbsp;{{ trans('Add tour Package') }}</a>&nbsp;&nbsp;
        ...
        <div class="col-md-12" style="overflow-x: scroll">
            <section class="card card-primary mb-4" style="width:180%">
                ...
                @include('TourOperator.TourPackages.get_company_tour_packages')
            </section>
        </div>
