@extends('layouts.main', ['title' => trans('Expired Tour Packages'), 'header' => trans('Expired Tour Packages')])
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p>We regret to inform you that these tour packages have expired due to the specified dates. However, we have good news! You have the opportunity to renew these packages by changing the dates and, if necessary, modifying other items.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row" style="overflow-x: scroll">
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:180%;">
                ...
                @include('TourOperator.TourPackages.expiredTourPackages.get_expired_tour_packages')
            </section>
        </div>
    </div>
