                ...
                <div class="card" style="margin: auto">
                    <div class="card-body">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p class="text-white">Edit the tour features on your package</p>
                                    <div class="row">
                                        <div class="col-xs-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <table>
                                                ...
                                                @if(!empty($tourPackageFeatures) && $tourPackageFeatures->count())
                                                    ...
                                                    @endforeach
                                                @else
                                                    <span class="text-danger">No Feature was added previously</span>
                                                @endif
                                                </tbody>
                                            </table>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p class="text-white">Edit activities included on your package</p>
                                    <div class="row">
                                        <div class="col-xs-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <table>
                                                <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    @endforeach
                                                @else
                                                <span class="text-danger">No activity was added previously</span>
                                                @endif
                                                </tbody>
                                            </table>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p class="text-white">Add Trips associated on your package</p>
                                    <div class="row">
                                        <div class="col-xs-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <table>
                                                <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    @endforeach
                                                @else
                                                <span>No safari list was added previously</span>
                                                @endif
                                                </tbody>
                                            </table>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p class="text-white">Add Accommodations in respective to safari days and places included on your package</p>
                                    <div class="row">
                                        <div class="col-xs-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <table>
                                                <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    @endforeach
                                                @else
                                                <span>No Accommodation was added previously!</span>
                                                @endif
                                                </tbody>
                                            </table>
                                        </div>
