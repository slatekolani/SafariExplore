@extends('layouts.main', ['title' => trans('Verified Tour Packages'), 'header' => trans('Verified Tour Packages')])
    ...
    <div class="row" style="overflow-x: scroll">
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:180%;">
                ...
                @include('TourOperator.TourPackages.verifiedTourPackages.get_verified_tour_packages')
            </section>
        </div>
    </div>
