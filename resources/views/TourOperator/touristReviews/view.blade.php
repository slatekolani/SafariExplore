            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="mailto:{{(\App\Models\TourOperator\TourPackages\TourPackageBookings\tourPackageBookings::find($touristReview->tour_package_booking_id)->tourist_email_address)}}" style="float: right" class="btn btn-primary btn-sm">Send Mail</a>
                    </div>
                </div>
            </div>
        </div>
