@extends('layouts.main', ['title' => trans('Verified Tour Companies'), 'header' => trans('Verified Tour Companies')])
...
@section('content')
    ...
    <div class="row" style="overflow-x: scroll">
        <div class="col-md-12">
            <section class="card card-primary mb-4" style="width:250%">
                <div class="card-actions">
                    {{--Action Links--}}

                </div>
                @include('TourOperator.adminView.Verified.get_verified_tour_operators_companies')
            </section>
        </div>
