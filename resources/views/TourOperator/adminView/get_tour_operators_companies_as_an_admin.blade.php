<table class="table table-hover table-responsive-md" id="tour_operators_companies-admin-table">
    <thead>
    <tr>
...
@push('after-scripts')
    ...
    <script  type="text/javascript">
        ...
        $(function() {
            var url = "{{ url("/") }}";
            var table= $('#tour_operators_companies-admin-table').DataTable({
                processing: true,
                serverSide: true,
                stateSave: true,
                searching: true,
                ...
                ajax: '{{ route('tourOperatorCompaniesManagement.getTourOperatorsCompanies') }}',
                columns: [
