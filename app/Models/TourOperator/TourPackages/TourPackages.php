...
namespace App\Models\TourOperator\TourPackages;
...
use App\Repositories\TourOperatorPackages\TourPackageAccommodations\tourPackageAccommodationsRepository;
use App\Repositories\TourOperatorPackages\TourPackageActivities\tourPackageActivitiesRepository;
use App\Repositories\TourOperatorPackages\TourPackageFeaturesRepository\tourPackageFeaturesRepository;
use App\Repositories\TourOperatorPackages\TourPackageTrips\tourPackageTripsRepository;
use Carbon\Carbon;
...
class TourPackages extends BaseModel
{
    ...
    public function getTourPackagesButtonActionLabelAttribute()
    {
        ...
        {
            case 0:
                 $btn='<a href="'.route('tourPackages.delete',$this->uuid).'" class="btn btn-danger btn-sm">Delete</a>';
                 return $btn;
            case 1:
                $btn='<a href="'.route('tourPackageBookings.index',$this->uuid).'" class="btn btn-primary btn-sm">Bookings</a>';
                $btn=$btn.'<a href="'.route('tourPackages.delete',$this->uuid).'" class="btn btn-danger btn-sm">Delete</a>';
                return $btn;
            default:
                $btn='<a href="'.route('tourPackages.delete',$this->uuid).'" class="btn btn-danger btn-sm">Delete</a>';
                return $btn;
    ...
    public function getDeletedTourPackagesButtonActionLabelAttribute()
    {
        ...
        {
            case 0:
                $btn='<a href="'.route('tourPackages.restoreDeletedTourPackages',$this->uuid).'" class="btn btn-warning btn-sm">Restore</a>';
                return $btn;
            case 1:
                $btn='<a href="'.route('tourPackages.restoreDeletedTourPackages',$this->uuid).'" class="btn btn-warning btn-sm">Restore</a>';
                return $btn;
